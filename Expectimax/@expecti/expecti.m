...
%             name1 = ans{1}; name2 = ans{2};
            name1 = 'Tulha'; name2 = 'Anas'; name3 = 'Dushman1';
            if isempty(name1) == 1
                name1 = 'Player 1';
            end
            if isempty(name2) == 1
            ...
            E1 = Player(name3,game, [7 7]);
            game.PlayerList = {P1 P2 E1};
            bd = game.GameBoard;
            game.GameFigure = gcf;
            p = [];
            pcol = {[1 0 0],[0 0 1], [0 1 0]};
            ax = gca;
